...
describe('EncodedQueryBuilder', function () {
    describe('#addQuery(field, value)', function () {
        it('should return an Is object when no comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', 'value');
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.Is);
    ...
    describe('#addQuery(field, comparator, value?)', function () {
        it('should return a Between object when a Between comparator is provided', function () {
            // String Dates
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.Between, '2017-05-30', '2017-05-31 10:10:10');
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.Between);
            chai_1.expect(part.part.field).to.equal('field');
            ...
            part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.Between, d1, d2);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value).to.have.length(2);
            ...
            chai_1.expect(part.part.get()).to.equal('fieldBETWEENjavascript:gs.dateGenerate(\'2017-05-30\',\'00:00:00\')@javascript:gs.dateGenerate(\'2017-05-31\',\'10:10:10\')');
            // Numbers
            part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.Between, 0, 10);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value).to.have.length(2);
        ...
        it('should return a DateMoreThan object when a DateMoreThan comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.DateMoreThan, 5, _1.Comparators.DateMoreThan.TimePeriods.Days, _1.Comparators.DateMoreThan.TimeDirection.BeforeOrAfter, 'field2');
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.DateMoreThan);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value[0]).to.equal(5);
            chai_1.expect(part.part.value[1]).to.equal(_1.Comparators.DateMoreThan.TimePeriods.Days);
            chai_1.expect(part.part.value[2]).to.equal(_1.Comparators.DateMoreThan.TimeDirection.BeforeOrAfter);
        ...
        it('should return a DateLessThan object when a DateLessThan comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.DateLessThan, 5, _1.Comparators.DateLessThan.TimePeriods.Days, _1.Comparators.DateLessThan.TimeDirection.BeforeOrAfter, 'field2');
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.DateLessThan);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value[0]).to.equal(5);
            chai_1.expect(part.part.value[1]).to.equal(_1.Comparators.DateLessThan.TimePeriods.Days);
            chai_1.expect(part.part.value[2]).to.equal(_1.Comparators.DateLessThan.TimeDirection.BeforeOrAfter);
            chai_1.expect(part.part.value[3]).to.equal('field2');
        ...
        it('should return a Dynamic object when a Dynamic comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.Dynamic, _1.Comparators.Dynamic.Filters.Me);
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.Dynamic);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value).to.equal(_1.Comparators.Dynamic.Filters.Me);
            chai_1.expect(part.part.get()).to.equal('fieldDYNAMIC' + _1.Comparators.Dynamic.Filters.Me);
        });
        it('should return an EndsWith object when an EndsWith comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.EndsWith, 'value');
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.EndsWith);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value).to.equal('value');
        ...
        it('should return a GreaterThan object when a GreaterThan comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.GreaterThan, 'value');
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.GreaterThan);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value).to.equal('value');
            chai_1.expect(part.part.get()).to.equal('field>value');
        });
        it('should return a GreaterThanField object when a GreaterThanField comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.GreaterThanField, 'field2');
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.GreaterThanField);
            chai_1.expect(part.part.field).to.equal('field');
        ...
        it('should return a GreaterThanOrEqualToField object when a GreaterThanOrEqualToField comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.GreaterThanOrEqualsField, 'field2');
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.GreaterThanOrEqualsField);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value).to.equal('field2');
        ...
        it('should return a GreaterThanOrEqualTo object when a GreaterThanOrEqualTo comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.GreaterThanOrEqualTo, 'value');
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.GreaterThanOrEqualTo);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value).to.equal('value');
            chai_1.expect(part.part.get()).to.equal('field>=value');
        });
        it('should return an In object when an In comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.In, 'value', 'value2');
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.In);
            chai_1.expect(part.part.field).to.equal('field');
            ...
            part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.In, ['value', 'value2']);
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.In);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value[0][0]).to.equal('value');
            chai_1.expect(part.part.value[0][1]).to.equal('value2');
            chai_1.expect(part.part.get()).to.equal('fieldINvalue,value2');
            part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.In, ['value', 'value2'], 'value3', ['value4']);
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.In);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value[0][0]).to.equal('value');
            chai_1.expect(part.part.value[0][1]).to.equal('value2');
        ...
        it('should return an Is object when an Is comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.Is, 'value');
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.Is);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value).to.equal('value');
            chai_1.expect(part.part.get()).to.equal('field=value');
        ...
        it('should return an IsAnything object when an IsAnything comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.IsAnything);
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.IsAnything);
            chai_1.expect(part.part.field).to.equal('field');
        ...
        it('should return an IsEmpty object when an IsEmpty comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.IsEmpty);
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.IsEmpty);
            chai_1.expect(part.part.field).to.equal('field');
        ...
        it('should return an IsEmptyString object when an IsEmptyString comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.IsEmptyString);
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.IsEmptyString);
            chai_1.expect(part.part.field).to.equal('field');
        ...
        it('should return an IsNot object when an IsNot comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.IsNot, 'value');
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.IsNot);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value).to.equal('value');
            chai_1.expect(part.part.get()).to.equal('field!=value');
        });
        it('should return an IsNotEmpty object when an IsNotEmpty comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.IsNotEmpty);
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.IsNotEmpty);
            chai_1.expect(part.part.field).to.equal('field');
        ...
        it('should return an IsNotSameAs object when an IsNotSameAs comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.IsNotSameAs, 'field2');
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.IsNotSameAs);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value).to.equal('field2');
        ...
        it('should return an IsSameAs object when an IsSameAs comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.IsSameAs, 'field2');
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.IsSameAs);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value).to.equal('field2');
        ...
        it('should return a LessThan object when a LessThan comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.LessThan, 'value');
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.LessThan);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value).to.equal('value');
            chai_1.expect(part.part.get()).to.equal('field<value');
        });
        it('should return a LessThanField object when a LessThanField comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.LessThanField, 'field2');
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.LessThanField);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value).to.equal('field2');
            chai_1.expect(part.part.get()).to.equal('fieldLT_FIELDfield2');
        });
        it('should return a LessThanField object when a LessThanField comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.LessThanOrEqualsField, 'field2');
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.LessThanOrEqualsField);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value).to.equal('field2');
        ...
        it('should return a LessThanOrEqualTo object when a LessThanOrEqualTo comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.LessThanOrEqualTo, 'value');
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.LessThanOrEqualTo);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value).to.equal('value');
            chai_1.expect(part.part.get()).to.equal('field<=value');
        });
        it('should return a GroupBy object when a GroupBy comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder();
        ...
        it('should return a Like object when a Like comparator is provided', function () {
            ...
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.Like);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value).to.equal('value');
        ...
        it('should return a NotIn object when a NotIn comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.NotIn, 'value', 'value2');
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.NotIn);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value[0][0]).to.equal('value');
            chai_1.expect(part.part.value[0][1]).to.equal('value2');
            chai_1.expect(part.part.get()).to.equal('fieldNOT INvalue,value2');
            part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.NotIn, ['value', 'value2']);
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.NotIn);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value[0][0]).to.equal('value');
            chai_1.expect(part.part.value[0][1]).to.equal('value2');
            chai_1.expect(part.part.get()).to.equal('fieldNOT INvalue,value2');
            part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.NotIn, ['value', 'value2'], 'value3', ['value4']);
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.NotIn);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value[0][0]).to.equal('value');
            chai_1.expect(part.part.value[0][1]).to.equal('value2');
        ...
        it('should return a Not Like object when a Not Like comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.NotLike, 'value');
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.NotLike);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value).to.equal('value');
        ...
        it('should return a NotOn object when a NotOn comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.NotOn, _1.Comparators.NotOn.DateRelativeOn.Yesterday);
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.NotOn);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value).to.equal(_1.Comparators.NotOn.DateRelativeOn.Yesterday);
            chai_1.expect(part.part.get()).to.equal('fieldNOTONYesterday@javascript:gs.daysAgoStart(1)@javascript:gs.daysAgoEnd(1)');
            part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.NotOn, '2017-05-30');
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.NotOn);
            chai_1.expect(part.part.field).to.equal('field');
        ...
        it('should return an On object when an On comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.On, _1.Comparators.On.DateRelativeOn.Yesterday);
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.On);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value).to.equal(_1.Comparators.On.DateRelativeOn.Yesterday);
            chai_1.expect(part.part.get()).to.equal('fieldONYesterday@javascript:gs.daysAgoStart(1)@javascript:gs.daysAgoEnd(1)');
            part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.On, '2017-05-30');
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.On);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value).to.equal('2017-05-30');
        ...
        it('should return a Relative object when a Relative comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.Relative, _1.Comparators.Relative.RelativeDirection.On, 5, _1.Comparators.Relative.RelativeTime.Hours, _1.Comparators.Relative.RelativeAsOf.BeforeNow);
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.Relative);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value[0]).to.equal(_1.Comparators.Relative.RelativeDirection.On);
            chai_1.expect(part.part.value[1]).to.equal(5);
            chai_1.expect(part.part.value[2]).to.equal(_1.Comparators.Relative.RelativeTime.Hours);
            chai_1.expect(part.part.value[3]).to.equal(_1.Comparators.Relative.RelativeAsOf.BeforeNow);
        ...
        it('should return an StartsWith object when an StartsWith comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.StartsWith, 'value');
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.StartsWith);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value).to.equal('value');
        ...
        it('should return a Trend object when a Trend comparator is provided', function () {
            var part = new _1.EncodedQueryBuilder().addQuery('field', _1.Comparators.Trend, _1.Comparators.Trend.TrendDirection.On, _1.Comparators.Trend.TrendDay.Monday);
            chai_1.expect(part.part).to.be.instanceOf(_1.Comparators.Trend);
            chai_1.expect(part.part.field).to.equal('field');
            chai_1.expect(part.part.value[0]).to.equal(_1.Comparators.Trend.TrendDirection.On);
            chai_1.expect(part.part.value[1]).to.equal(_1.Comparators.Trend.TrendDay.Monday);
    ...
    describe('#build()', function () {
        it('should return a complete query string', function () {
            var builder = new _1.EncodedQueryBuilder();
            builder.addQuery('field', 'value');
            chai_1.expect(builder.build()).to.equal('field=value');
            builder = new _1.EncodedQueryBuilder();
            builder.addQuery('field', 'value').and('field2', _1.Comparators.IsEmpty);
            chai_1.expect(builder.build()).to.equal('field=value^field2ISEMPTY');
            builder = new _1.EncodedQueryBuilder();
            builder.addQuery('field', 'value').and('field2', _1.Comparators.IsEmpty).or('field3', _1.Comparators.GreaterThan, 5);
            ...
            builder.addQuery('active', 'true')
                .and('active', _1.Comparators.Is, 'true')
                .or('active', 'true');
            builder.addOrQuery('active', 'true')
                .or('active', _1.Comparators.Is, 'true')
                .and('active', _1.Comparators.Is, 'true');
            builder.addOrderBy('active', _1.Comparators.Direction.Ascending);
            ...
            builder = new _1.EncodedQueryBuilder();
            builder.addQuery('description', _1.Comparators.IsNotEmpty);
            builder.addOrderBy('active', _1.Comparators.Direction.Ascending);
            builder.addOrderBy('sys_created_by', _1.Comparators.Direction.Descending);
